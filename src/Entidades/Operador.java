...
public class Operador {
    ...
    lo utilizamos dentro de la clase Entidades.Operador para manejar una serie de referencias, por medio de las cuales
    ...
    reducir la necesidad de modificar o insertar código en las clases que hagan uso de Entidades.Operador.
    ...
    tener que estar declarando una subclase nueva cada vez que se agrega un servicio al Entidades.Operador.
