...
/*
    public static void servicioVentaOperador(Negocio local, Scanner getData){
        ...
        //Gracias al uso del enum insertado en Entidades.Operador en este punto no hay necesidad de modificar o insertar código
        //ya que gracias a los bucles se presentan las opciones contenidas en el arraylist<Entidades.Operador> de Entidades.Negocio y así
